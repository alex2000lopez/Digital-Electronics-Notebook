...
\begin{figure}[H]
    ...
    \ifnum\value{ANIMATION}=1 {
        \animategraphics[controls,loop,scale=0.78]{1}{Graphics/Practice 6/SAFECODE/ANIMATION/F}{0}{5}
    } 
    \else {
        \includegraphics[scale=0.78]{Graphics/Practice 6/SAFECODE/ANIMATION/F2.pdf}
    }\fi
